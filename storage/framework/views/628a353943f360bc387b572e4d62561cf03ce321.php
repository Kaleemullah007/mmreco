            ...
            <div class="matching-table">
              <div class="col-sm-6">
                  ...
                  <form id="bst-search-form" name="bst-search-form" class="" method="post" action="" autocomplete="off" role="form">
                    ...
                    <div class="col-md-3 padding-0">
                      <div class="input-group">
                        <input type="text" class="report_datepicker form-control" style="margin-top:0px;" placeholder="<?php echo e(trans('general.start_date')); ?>" data-date-format="yyyy-mm-dd" name="bst_start_date" id="bst_start_date" value="">
                    ...
                    <div class="col-md-3 padding-0" >
                      <div class="input-group">
                        <input type="text" class="report_datepicker form-control" style="margin-top:0px;" placeholder="<?php echo e(trans('general.end_date')); ?>" data-date-format="yyyy-mm-dd" name="bst_end_date" id="bst_end_date" value="">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      </div>          
                    </div>
                    <div class="col-md-3">
                      <div class="">
                        <button type="button" class="btn btn-success" onclick="filterBankStatement();"><i class="fa fa-search icon-white"></i> <?php echo e(trans('general.search')); ?></button>
                ...
                <table
                  ...
                  id="table"
                  data-toggle="table"           
                  data-url="<?php echo e(route('manualtransaction/getBstDatatable')); ?>"
                  data-cookie="true"
                  ...
                  <thead>
                    <tr>
                      ...
                      <th  data-class="date_width" data-searchable="true" data-sortable="true" data-field="date"><?php echo e(trans('admin/bankstmt/table.date')); ?></th>

                      <th data-class="sowShort-150" data-searchable="true" data-sortable="true" data-field="description"><?php echo e(trans('admin/bankstmt/table.description')); ?></th>

                      <th data-class="sowShort" data-searchable="true" data-sortable="true" data-field="type"><?php echo e(trans('admin/bankstmt/table.type')); ?></th>

                      <th data-class="dataTable-text-right" data-searchable="true" data-sortable="true" data-field="debit"><?php echo e(trans('admin/bankstmt/table.debit')); ?></th>

                      <th data-class="dataTable-text-right" data-searchable="true" data-sortable="true" data-field="credit"><?php echo e(trans('admin/bankstmt/table.credit')); ?></th>
              ...
              <div class="col-sm-6">
                ...
                <div class="table table-responsive" >
                  ...
                  <form id="txn-search-form" name="txn-search-form" class="" method="post" action="" autocomplete="off" role="form">
                    <div class="col-md-3">
                      <?php echo e(Form::select('TransactionDrop', $TransactionDrop, $txnDrop, ['id' => 'TransactionDrop','class' => 'form-control'])); ?>

                    </div>
                    <div class="col-md-3 padding-0">
                      <div class="input-group">
                        <input type="text" class="report_datepicker form-control" style="margin-top:0px;" placeholder="<?php echo e(trans('general.start_date')); ?>" data-date-format="yyyy-mm-dd" name="txn_start_date" id="txn_start_date" value="<?php echo e($txn_start_date); ?>">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 padding-0" >
                      <div class="input-group">
                        <input type="text" class="report_datepicker form-control" style="margin-top:0px;" placeholder="<?php echo e(trans('general.end_date')); ?>" data-date-format="yyyy-mm-dd" name="txn_end_date" id="txn_end_date" value="<?php echo e($txn_end_date); ?>">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      </div>          
                    </div>
                    <div class="col-md-3">
                      <div class="">
                        <button type="button" class="btn btn-success" onclick="filterTransaction();"><i class="fa fa-search icon-white"></i> <?php echo e(trans('general.search')); ?></button>
             ...
             <a class="btn btn-primary pull-right" href="javascript:void(0)" onclick="submitMatches();">Submit Matches</a>
                <a class="btn btn-primary bg-red pull-right" href="<?php echo e(route('manualtransaction/resetTxn')); ?>" style="margin-right: 5px;">Reset Matches</a>
          </div>
          <div class="col-sm-12">
...
<?php echo $__env->make('partials.bootstrap-table', ['exportFile' => 'users-export', 'search' => true], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  if($("#Bankmaster").val() != '' && $('#bst_start_date').val() != '' && $('#bst_end_date').val() != '')
  {
    $("#bstValidationError").text('');
      ...
      var table = $('#table').bootstrapTable(
          'refresh', {
            url: "<?php echo e(config('app.url')); ?>/manualtransaction/getBstDatatable",
...
function bstRadioSelect(obj,id,type)
{
  ...
  $.ajax({
          type: 'POST',
          url: "<?php echo e(config('app.url')); ?>/manualtransaction/bstRadioSelect", 
...
function removeBankStatement(InputId , id , type)
{
  ...
  $.ajax({
          type: 'POST',
          url: "<?php echo e(config('app.url')); ?>/manualtransaction/bstRadioDelete", 
          data: {id:id,type : type},
          success:function( data ) 
          { 
              if($.trim(data) == "success")
...
function filterTransaction()
{
  if($("#TransactionDrop").val() != '' && $('#txn_start_date').val() != '' && $('#txn_end_date').val() != '')
  {
    ...
    $.ajax({
            type: 'POST',
            url: "<?php echo e(config('app.url')); ?>/manualtransaction/filterTransaction", 
...
function txnCheckBoxSelect(obj,id,type)
{
  if($(obj).prop("checked") == true)
  {
      ...
      $.ajax({
              type: 'POST',
              url: "<?php echo e(config('app.url')); ?>/manualtransaction/txnSelect", 
              data: {id:id,type : type},
              success:function( data ) 
              { 
                  if($.trim(data) == "success")
...
function removeTransactionData(InputId , id , type)
{
  ...
  $.ajax({
          type: 'POST',
          url: "<?php echo e(config('app.url')); ?>/manualtransaction/transactionDelete", 
          data: {id:id,type : type},
          success:function( data ) 
          { 
              if($.trim(data) == "success")
...
function submitMatches()
{
  ...
  else
  {
    ...
    $.ajax({
      type: 'POST',
      url: "<?php echo e(config('app.url')); ?>/manualtransaction/submitMatches", 
...
function bootstrapTableCall()
{
  ...
  else if($('#TransactionDrop').val() == 'balance_adj')
  {
    ...
    $('.snipe-table1').bootstrapTable({
        ...
        exportTypes: ['excel'],
        exportOptions: {
            fileName: '<?php echo e("asdds" . "-"); ?>' + (new Date()).toISOString().slice(0,10),
