...
<?php echo e(trans('admin/banktxn/general.banktxn_import')); ?>
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <div class="box box-default">
        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="<?php echo e(url('banktransactions/changeflag')); ?>" onsubmit="startLoading();">
            <div class="box-body">
                <!-- CSRF Token -->
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />

                <p><strong>Change Transaction Flag.</strong>. </p>
                <div class="row">
                    <div class="col-md-6">
    ...
    <div class="box box-default">
        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="" onsubmit="startLoading();">
            <div class="box-body">
                ...
                <p><strong>Upload Transaction File.</strong>. </p>

                    <div class="form-group {!! $errors->first('transaction_file', 'has-error') }}">
                        <label for="first_name" class="col-sm-3 control-label"><?php echo e(trans('admin/banktxn/general.importfile')); ?></label>
                                <div class="col-sm-5">
