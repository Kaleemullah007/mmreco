...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/js/plugins/colorpicker/bootstrap-colorpicker.min.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('assets/js/plugins/datepicker/bootstrap-datepicker.css')); ?>">

    <!-- jvectormap -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/js/plugins/jvectormap/jquery-jvectormap-1.2.2.css')); ?>">
    <!-- Theme style -->
    ...
    <link rel="stylesheet" href="<?php echo e(elixir('assets/css/app.css')); ?>">
    ...
    <style type="text/css">
    	.login-page
    	{
            background-image: url('<?php echo e(config('app.url')); ?>/assets/img/marqbg.jpg');
