<?php $__env->startSection('title'); ?>
	<?php echo e(trans('admin/agencybanking/general.approved_agency_banking')); ?>
		...
		<div class="box box-default">
			...
			<div class="box-body">
				<div class="table table-responsive">
					<form id="create-search-form" class="" method="get" action="<?php echo e(route('approved')); ?>" autocomplete="off" role="form" enctype="multipart/form-data">
					...
					<table
						...
						id="table"
						data-toggle="table"						
						data-url="<?php echo e(route('api.agencybanking.approved.list', array('start_date'=>(Input::get('start_date'))?Input::get('start_date'):'','end_date'=>(Input::get('end_date')?Input::get('end_date'):'')))); ?>"
						data-cookie="true"
...
{
    $.removeCookie('abTableDisplay.bs.table.searchText', { path: '/<?php echo e(config('app.project_name')); ?>/public/admin' });
    $.removeCookie('abTableDisplay.bs.table.sortName', { path: '/<?php echo e(config('app.project_name')); ?>/public/admin' });
    $.removeCookie('abTableDisplay.bs.table.sortOrder', { path: '/<?php echo e(config('app.project_name')); ?>/public/admin' });
    $.removeCookie('abTableDisplay.bs.table.pageNumber', { path: '/<?php echo e(config('app.project_name')); ?>/public/admin' });
    $.removeCookie('abTableDisplay.bs.table.pageList', { path: '/<?php echo e(config('app.project_name')); ?>/public/admin' });
 
    window.location.href="<?php echo e(url('agencybanking/approved')); ?>";
}
