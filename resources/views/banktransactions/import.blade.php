...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <div class="box box-default">
        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{ url('banktransactions/changeflag') }}" onsubmit="startLoading();">
            <div class="box-body">
                <!-- CSRF Token -->
            ...
            <div class="box-body">
                ...
                <p><strong>Upload Transaction File.</strong>. </p>
                    ...
                    <div class="form-group {!! $errors->first('transaction_file', 'has-error') }}">
                        <label for="first_name" class="col-sm-3 control-label">{{ trans('admin/banktxn/general.importfile') }}</label>
                                <div class="col-sm-5">
