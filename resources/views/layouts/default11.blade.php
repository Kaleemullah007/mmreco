         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li {!! (Request::is('bankbalance/*') ? ' class="active"' : '') !!}>
                  <a href="javascript:void(0)">
                  ...
                  <li {!! (Request::is('agencybanking/*') ? ' class="active"' : '') !!}>
                     <a href="javascript:void(0)">
                  ...
                  <li {!! (Request::is('card/*') ? ' class="active"' : '') !!}>
                  <a href="javascript:void(0)">
                  ...
                  <li {!! (Request::is('rejectedbacs/*') ? ' class="active"' : '') !!}>
                  <a href="javascript:void(0)">
                  ...
                  <li {!! (Request::is('settelementsummary/*') ? ' class="active"' : '') !!}>
                  <a href="javascript:void(0)">
                  ...
                  <li {!! (Request::is('dailybalanceshift/*') ? ' class="active"' : '') !!}>
                  <a href="javascript:void(0)">
                  ...
                  <li {!! (Request::is('monthlybalanceshift/*') ? ' class="active"' : '') !!}>
                  <a href="javascript:void(0)">
                  <i class="fa fa-calendar"></i>
                  ...
                  <li {!! (Request::is('mainrecodaily/*') ? ' class="active"' : '') !!}>
                     <a href="javascript:void(0)">
                     <i class="fa fa-calendar"></i>
                  ...
                  <li {!! (Request::is('banktransactions/*') ? ' class="active"' : '') !!}>
                     <a href="javascript:void(0)">
