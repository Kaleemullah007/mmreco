            ...
            <div class="box-body">
                <div class="table table-responsive">
                    ...
                    <table
                        ...
                        id="table"
                        data-toggle="table"                     
                        data-url="{{ route('api.monthlybalanceshift.list', array('pan'=>(Input::get('pan'))?Input::get('pan'):'','start_date'=>(Input::get('start_date'))?Input::get('start_date'):'','end_date'=>(Input::get('end_date')?Input::get('end_date'):''))) }}"
                        data-cookie="true"
                        ...
                        <thead>
                            <tr>                                
                                ...
                                <th data-searchable="true" data-sortable="true" data-field="trans_settled_not_adj_gps">{{ trans('admin/monthlybalanceshift/table.Transactions_in_Timing') }}</th>  

                                <th data-searchable="true" data-sortable="true" data-field="trans_settled_not_adj_gps_2">{{ trans('admin/monthlybalanceshift/table.Transactions_in_Timing2') }}</th>
