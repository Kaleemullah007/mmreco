...
{{-- Page title --}}
@section('title')
Re-Generate Monthly Balance Shift
@parent
@stop
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('start_date') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group col-md-9 ">
                                <input type="text" class="datepicker1 form-control" data-date-format="mm-yyyy" placeholder="{{ trans('general.select_date') }}" name="start_date" id="start_date" value="{{Input::old('start_date')}}" autocomplete="off">
