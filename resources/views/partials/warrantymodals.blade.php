    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="dynamic-form-row">
                    <div class="col-md-4 col-xs-12"><label for="modal-category_type">{{ trans('admin/categories/general.domain') }}:
                        </label></div>
                    <div class="col-md-8 col-xs-12 required">{{ Form::select('modal-category_type', $category_types ,'', array('class'=>'select2 parent', 'style'=>'width:100%','id' => 'modal-category_type')) }}</div>
                </div>

                <div class="dynamic-form-row">
                    <div class="col-md-4 col-xs-12"><label for="modal-location_list">Location:
                        </label></div>
                    <div class="col-md-8 col-xs-12 required">{{ Form::select('modal-location_list', $location_list ,'', array('class'=>'select2 parent', 'style'=>'width:100%','id' => 'modal-location_list')) }}</div>
                </div>
                ...
                <div class="dynamic-form-row">
                    <div class="col-md-4 col-xs-12"><label for="modal-eol">EOL:</label></div>
                    <div class="col-md-8 col-xs-12"><input type='text' id='modal-eol' class="form-control"></div>
                </div>
