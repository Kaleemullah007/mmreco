...
class CreateCardbaladjustTable extends Migration {
	...
	public function up()
	{
		Schema::create('cardbaladjust', function(Blueprint $table)
		{
			...
			$table->string('extra_flags_cr_dr')->nullable();
			$table->timestamps();
